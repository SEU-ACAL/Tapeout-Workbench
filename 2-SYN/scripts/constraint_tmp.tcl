...
create_clock [get_ports clock] 									-period $PAD_cpu_clock_period 			-waveform [list 0 [expr $PAD_cpu_clock_period/2.0]] -name clock_uncore
...
set_clock_uncertainty [expr $PAD_cpu_clock_period * 0.3]        [get_clocks clock_uncore]
...
set_clock_transition  [expr $PAD_cpu_clock_period * 0.1]        [get_clocks clock_uncore]
...
set_input_delay   [expr $PAD_cpu_clock_period * 0.7]        -clock [get_clocks clock_uncore] $data_inputs            
set_output_delay  [expr $PAD_cpu_clock_period * 0.7]        -clock [get_clocks clock_uncore] $data_outputs
